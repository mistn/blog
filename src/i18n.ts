...
export const ui = {
  zh: {
    ...
    pages: {
      postsTitle: "文章",
      homeDesc:
        "miuchan 的个人技术博客，分享 VPS 运维、自托管服务搭建、开发工具配置与个人工作流优化等领域的原创笔记与详细教程。",
      postsDesc:
      ...
      archivesDesc: "按时间线浏览 miuchan 博客的全部已发布文章，按年份和月份整理，方便回溯历史技术笔记。",
      searchTitle: "搜索",
      searchDesc: "搜索站内技术文章、笔记和教程，通过关键词快速定位你需要的内容。",
      animeTitle: "追番列表",
      animeFullTitle: "追番列表 | miuchan",
      animeDesc: "可按年份或全部查看 AniList normal 列表中已看完的动画。",
      animeEyebrow: "Anime Archive",
      toolsTitle: "工具",
      toolsFullTitle: "工具 | miuchan",
      toolsDesc: "一些实验性项目和小玩意儿。",
      friendsTitle: "友链",
      friendsDesc:
        "miuchan 的友情链接页面，收录了多个优质个人独立博客，欢迎通过评论区或邮件提交申请交换友链。",
      friendsEyebrow: "Link Exchange",
      weeklyTitle: "周记",
      weeklyDesc: "定期记录与分享。",
      aboutTitle: "关于",
      aboutEyebrow: "About",
      aboutDesc: "了解 miuchan 的个人简介、自托管服务列表（听歌记录、壁纸站、临时邮箱等）以及联系方式。",
      notFoundTitle: "页面未找到",
      notFoundCta: "返回首页",
      notFoundDesc:
        "您访问的页面不存在，可能已被移除或链接错误。返回 miuchan 博客首页浏览更多技术文章。",
    },
    sidebar: {
      notebook: "笔记",
      recent: "最近",
